...
public class Internal_Report extends ReportCardDataI {
    String Templates[];
    int emarks[][];
    Internal_Report()
    ...
    void GenerateIRC()throws Exception {
        ...
        XWPFTableRow tableRowTwo = table.createRow();
          ...
          tableRowTwo.getCell(2).setText(Integer.toString(emarks[j][0]));
      
       
        XWPFTableRow tableRowThree = table.createRow();
        tableRowThree.getCell(0).setText("SIGNALS AND SYSTEM ANALYSIS");
        tableRowThree.getCell(1).setText("30");
        tableRowThree.getCell(2).setText(Integer.toString(emarks[j][1]));
        
        
        XWPFTableRow tableRowFour = table.createRow();
        tableRowFour.getCell(0).setText("COMPUTER ORGANIZATION");       
        tableRowFour.getCell(1).setText("30");
        tableRowFour.getCell(2).setText(Integer.toString(emarks[j][2]));     
        
        XWPFTableRow tableRowFive = table.createRow();
        tableRowFive.getCell(0).setText("PROGRAMMING USING JAVA");
        tableRowFive.getCell(1).setText("30");
        tableRowFive.getCell(2).setText(Integer.toString(emarks[j][3]));   
        
        XWPFTableRow tableRowSix = table.createRow();
        tableRowSix.getCell(0).setText("PROGRAMMING LANGUAGES");
        tableRowSix.getCell(1).setText("30");
        tableRowSix.getCell(2).setText(Integer.toString(emarks[j][4]));   
        
        XWPFTableRow tableRowSeven = table.createRow();
        tableRowSeven.getCell(0).setText("MICROPROCESSOR AND INTERFACING");
        tableRowSeven.getCell(1).setText("30");
        tableRowSeven.getCell(2).setText(Integer.toString(emarks[j][5]));   
        
        XWPFTableRow tableRowEight = table.createRow();
        tableRowEight.getCell(0).setText("TOTAL : ");
        tableRowEight.getCell(1).setText("180");
        tableRowEight.getCell(2).setText(Integer.toString(total=emarks[j][0]+emarks[j][1]+emarks[j][2]+emarks[j][3]+emarks[j][4]+emarks[j][5]));
        avg=total*100/180;
        XWPFTableRow tableRowNine = table.createRow();
        tableRowNine.getCell(0).setText("GRADE : ");
        tableRowNine.getCell(1).setText(null);
        tableRowNine.getCell(2).setText(gradecal(avg));
